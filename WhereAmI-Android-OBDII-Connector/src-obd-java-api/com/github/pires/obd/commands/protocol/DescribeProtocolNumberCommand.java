...
/**
 * Describe the Protocol by Number. It returns a number which represents the
 * current obdProtocol. If the automatic search function is also enabled, the
 * number will be preceded with the letter ‘A’. The number is the same one
 * that is used with the set obdProtocol and test obdProtocol commands.
 * 
 * @author pires
 * @version $Id: $Id
 * @since 1.0-RC12
...
public class DescribeProtocolNumberCommand extends ObdCommand {
	...
	protected void performCalculations() {
		...
		char protocolNumber;
		if (result.length() == 2) {// the obdProtocol was set automatic and its
									// format A#
	...
	/**
	 * <p>
	 * Getter for the field <code>obdProtocol</code>.
	 * </p>
	 * 
