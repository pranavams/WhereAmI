...
public abstract class PressureCommand extends ObdCommand implements SystemOfUnits {
	 ...
	 * @param other
	 *            a
	 *            {@link com.github.pires.obd.commands.pressure.PressureCommand}
	 *            object.
	 */
	...
	public String getFormattedResult() {
		return useImperialUnits ? String.format("%.1f%s", getImperialUnit(), getResultUnit()) : String.format("%d%s", pressure,
				getResultUnit());
	}
