...
public class PermanentTroubleCodesCommand extends ObdCommand {
	 ...
	 * @param other
	 *            a
	 *            {@link com.github.pires.obd.commands.control.PermanentTroubleCodesCommand}
	 *            object.
	 */
	...
	protected void performCalculations() {
		...
		if (canOneFrameLength <= 16 && canOneFrameLength % 4 == 0) {// CAN(ISO-15765)
																	// protocol
																	// one
																	// frame.
			workingData = canOneFrame;// 4Ayy{codes}
			startIndex = 4;// Header is 4Ayy, yy showing the number of data
							// items.
		} else if (result.contains(":")) {// CAN(ISO-15765) protocol two and
											// more frames.
			workingData = result.replaceAll("[\r\n].:", "");// xxx4Ayy{codes}
			startIndex = 7;// Header is xxx4Ayy, xxx is bytes of information to
							// follow, yy showing the number of data items.
		} else {// ISO9141-2, KWP2000 Fast and KWP2000 5Kbps (ISO15031)
				// protocols.
