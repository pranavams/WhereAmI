...
public class PendingTroubleCodesCommand extends ObdCommand {
	 ...
	 * @param other
	 *            a
	 *            {@link com.github.pires.obd.commands.control.PendingTroubleCodesCommand}
	 *            object.
	 */
	...
	protected void performCalculations() {
		...
		if (canOneFrameLength <= 16 && canOneFrameLength % 4 == 0) {// CAN(ISO-15765)
			...
			startIndex = 4;// Header is 47yy, yy showing the number of data
							// items.
		} else if (result.contains(":")) {// CAN(ISO-15765) protocol two and
											// more frames.
			workingData = result.replaceAll("[\r\n].:", "");// xxx47yy{codes}
			startIndex = 7;// Header is xxx47yy, xxx is bytes of information to
