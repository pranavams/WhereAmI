...
public abstract class TemperatureCommand extends ObdCommand implements SystemOfUnits {
	 ...
	 * @param other
	 *            a
	 *            {@link com.github.pires.obd.commands.temperature.TemperatureCommand}
	 *            object.
	 */
	...
	public String getFormattedResult() {
		return useImperialUnits ? String.format("%.1f%s", getImperialUnit(), getResultUnit()) : String.format("%.0f%s", temperature,
				getResultUnit());
	}
